...
Accuracy: The bot correctly answers at least 90% of routine advising questions (degree requirements, prerequisites, specialization rules, form routing) as validated against official Busch School curriculum documentation.
Adoption: At least 30% of enrolled Busch undergraduates use the tool within the first semester of launch.
Advisor load reduction: Academic Services reports a measurable reduction in routine inquiry volume, freeing advisor time for high-complexity student cases.
Student satisfaction: Post-session survey scores average 4 out of 5 or higher on helpfulness and accuracy.
